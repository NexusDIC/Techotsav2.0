...
function HomePage() {
  return (
    <div className="w-screen lg:h-screen px-4 lg:px-10 py-8 grid grid-cols-1 lg:grid-cols-6 lg:grid-rows-6 gap-4">
      ...
      <motion.div
        drag
        className="lg:col-start-3 lg:col-end-5 lg:row-start-1 lg:row-end-5 border-2 border-black w-full h-full rounded-2xl flex flex-col items-center justify-center order-2 lg:order-auto"
      >
      ...
      <motion.div
        drag
        className="lg:col-start-1 lg:col-end-3 lg:row-start-2 lg:row-end-5 border-2 border-black w-full h-full rounded-2xl order-4 lg:order-auto"
      >
      ...
      <motion.div
        drag
        className="lg:col-start-5 lg:col-end-7 lg:row-start-3 lg:row-end-6 border-2 border-black w-full h-full rounded-2xl order-3 lg:order-auto"
      >
        <Speakers />
      </motion.div>
      ...
      <motion.div
        drag
        className="lg:col-start-1 lg:col-end-3 lg:row-start-5 lg:row-end-7 border-2 border-black w-full h-full rounded-2xl order-5 lg:order-auto"
      >
      ...
      <motion.div
        drag
        className="lg:col-start-3 lg:col-end-5 lg:row-start-5 lg:row-end-7 border-2 border-black w-full h-full rounded-2xl order-6 lg:order-auto"
      >
      ...
      <motion.div
        drag
        className="lg:col-start-5 lg:col-end-7 lg:row-start-6 lg:row-end-7 border-2 border-black w-full h-full rounded-2xl order-8 lg:order-auto"
      >
